...
def build_generator(input_a, input_b, name="generator", skip=False, neuron_share=False, cs=1, rotate=False):
    ...
    with tf.variable_scope(name) as scope:
        ...
        if neuron_share:
            o_r9_b = tf.nn.relu((1 - cs) * o_r9_b_u + cs * o_r8_u)
        ...
        if neuron_share:
            o_r8_b = tf.nn.relu((1 - cs) * o_r8_b_u + cs * o_r7_u)
        ...
        if neuron_share:
            o_r7_b = tf.nn.relu((1 - cs) * o_r7_b_u + cs * o_r6_u)
        ...
        if neuron_share:
            o_r6_b = tf.nn.relu((1 - cs) * o_r6_b_u + cs * o_r5_u)
        ...
        if neuron_share:
            o_r5_b = tf.nn.relu((1 - cs) * o_r5_b_u + cs * o_r4_u)
        ...
        if neuron_share:
            o_r4_b = tf.nn.relu((1 - cs) * o_r4_b_u + cs * o_r3_u)
        ...
        if neuron_share:
            o_r3_b = tf.nn.relu((1 - cs) * o_r3_b_u + cs * o_r2_u)
        ...
        if neuron_share:
            o_r2_b = tf.nn.relu((1 - cs) * o_r2_b_u + cs * o_r1_u)
        ...
        # if neuron_share:
        #     o_r1_b = tf.nn.relu((1 - cs) * o_r1_b_u + cs * o_c3_u)
        ...
        # if neuron_share:
        #     o_c3_b = tf.nn.relu((1 - cs) * o_c3_b_u + cs * o_c2_u)
        ...
        # if neuron_share:
        #     o_c2_b = tf.nn.relu((1 - cs) * o_c2_b_u + cs * o_c1_u)
